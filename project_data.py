...
for key in graph_dict_keys:
    
    i = graph_list.index(key)
    
    bnb_time_new.append(bnb_time[i])
    approx_time_new.append(approx_time[i])
    lc1_time_new.append(lc1_time[i])
    lc2_time_new.append(lc2_time[i])
    bnb_error_new.append(bnb_error[i])
    approx_error_new.append(approx_error[i])
    lc2_error_new.append(lc2_error[i])
    lc1_error_new.append(lc1_error[i])

bnb_time_new, bnb_time = bnb_time, bnb_time_new
approx_time_new, approx_time = approx_time, approx_time_new
lc1_time_new, lc1_time = lc1_time, lc1_time_new
lc2_time_new, lc2_time = lc2_time, lc2_time_new
bnb_error_new, bnb_error = bnb_error, bnb_error_new
approx_error_new, approx_error = approx_error, approx_error_new
lc2_error_new, lc2_error = lc2_error, lc2_error_new
lc1_error_new, lc1_error = lc1_error, lc1_error_new
    
    
    
graph_list = graph_dict_keys
